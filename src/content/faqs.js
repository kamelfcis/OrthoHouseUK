...
export const faqsPage = {
  ...
  cta: {
    ...
    body: 'Our Team is ready to help with product literature, quotations, and partnership discussions.',
    button: 'Contact us',
    path: '/contact'
  }
}
...
export const faqsFallbackItems = [
  ...
  },
  {
    ...
    answer: "TRASER®'s open-pore 3D printing trabecular matrix provides an ideal scaffold for osteoblast migration and vascularisation. In stemless configurations, the Humeral Core Cage with TRASER® delivers immediate mechanical stability and long-term bone preservation without invading the humeral canal.\n\nSource: Permedica Orthopaedics – TRASER® Technology White Paper & Surgical Technique",
    display_order: 3
  },
  {
    id: 'static-m4',
  ...
  },
  {
    id: 'static-m7',
    category: 'mirai_shoulder',
    question: "Can UK consultants visit a reference centre, attend workshops, or discuss clinical outcomes with peer surgeons?",
  ...
  },
  {
    ...
    answer: "OSTEOSYNT® is used across orthopaedics, dentistry, plastic, and maxillofacial surgery to repair, reconstruct, or recover bone loss. OSTEOSYNT® has been used for over 40 years in infections, revision surgery, spine deformities, fractures, fusions, revision prosthesis, pseudo arthritis, and more.",
    display_order: 4
  },
  {
    id: 'static-o5',
  ...
  },
  {
    ...
    answer: "Please visit our Contact page to speak with your local OrthoHouse representative.",
    display_order: 9
  },
  {
    id: 'static-x1',
